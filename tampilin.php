...
<body background = "nike.jpg">
    ...
    <tr>
        ...
        <td><center> Gambar </td>
        <td><center> Harga </td>
        <td colspan = "2" width="20"><center> Aksi </th></br>
...
<tbody>
    ...
    while($show = mysqli_fetch_array($data)){
        ...
        <tr>
            ...
            <td><center><a href = "update.php?id=<?php echo $show['id'];?>">Edit&nbsp&nbsp<a href = "deletesql.php?id=<?php echo $show['id'];?>"onclick="return confirm('Apakah anda ingin Menghapus?')">Delete</a></a></td>
